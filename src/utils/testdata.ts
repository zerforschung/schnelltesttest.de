...
export type TestData ={ at_nr: string; ref_nr: string; manufacturer: string; test_name: string; target_antigen: string; "sensitivity_cq<25": string; "sensitivity_cq25-30": string; "sensitivity_cq>30": string; sensitivity_total: string; };
