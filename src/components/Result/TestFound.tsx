  ...
  return (
    <LogoHeadingPage>
      ...
      <p style={{ fontStyle: 'italic' }}>
        <Translate
          id="test.warning"
          defaultMessage="Vorsicht: Diese Zahlen wurden vor Omikron erhoben, allerdings {link}"
          values={{
            link: (
              <a href="https://www.pei.de/DE/newsroom/hp-meldungen/2021/211230-antigentests-omikron-variante.html">
                <Translate
                  id="test.omikronLinkDescription"
                  defaultMessage="schätzt das PEI Antigentests auch für den Nachweis von Omikron-Infektion als geeignet ein"
                />
              </a>
            ),
          }}
